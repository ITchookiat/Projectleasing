                  ...
                  <div class="card card-warning card-tabs">
                    <div class="card-header p-0 pt-1">
                      <ul class="nav nav-tabs" id="custom-tabs-five-tab" role="tablist">
                        <li class="nav-item">
                          <a class="nav-link MainPage" href="{{ route('MasterMicroPloan.index') }}?type={{$type}}">หน้าหลัก</a>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="row">
                              ...
                              <div class="col-6">
                                <div class="form-group row mb-0">
                                  ...
                                  <div class="col-sm-8">
                                    @if(auth::user()->type == "Admin" or auth::user()->position == "MANAGER")
                                      <select name="securitiesMP" class="form-control form-control-sm" >
                                        <option value="" selected>--- ประเภทหลักทรัพย์ ---</option>
                                        <option value="โฉนด" {{ ($data->securities_MP === 'โฉนด') ? 'selected' : '' }}>โฉนด</option>
                                        <option value="นส.3" {{ ($data->securities_MP === 'นส.3') ? 'selected' : '' }}>นส.3</option>
                                        <option value="นส.3 ก" {{ ($data->securities_MP === 'นส.3 ก') ? 'selected' : '' }}>นส.3 ก</option>
                                        <option value="นส.4" {{ ($data->securities_MP === 'นส.4') ? 'selected' : '' }}>นส.4</option>
                                        <option value="นส.4 จ" {{ ($data->securities_MP === 'นส.4 จ') ? 'selected' : '' }}>นส.4 จ</option>
                                      </select>
                                    @else
                                      @if($GetDocComplete != Null)
                                        <input type="text" name="securitiesMP" value="{{ $data->securities_MP }}" class="form-control form-control-sm"  placeholder="ประเภทหลักทรัพย์" readonly/>
                                      @else
                                        <select name="securitiesMP" class="form-control form-control-sm" >
                                          <option value="" selected>--- ประเภทหลักทรัพย์ ---</option>
                                          <option value="โฉนด" {{ ($data->securities_MP === 'โฉนด') ? 'selected' : '' }}>โฉนด</option>
                            ...
                            <div class="row">
                              <div class="col-6">
                                <div class="form-group row mb-0">
                                  ...
                                  <div class="col-sm-8">
                                    @if(auth::user()->type == "Admin" or auth::user()->position == "MANAGER")
                                      <input type="text" name="deednumberMP" value="{{$data->deednumber_MP}}" class="form-control form-control-sm"  placeholder="เลขที่โฉนด" />
                                    @else
                                      <input type="text" name="deednumberMP" value="{{$data->deednumber_MP}}" class="form-control form-control-sm"  placeholder="เลขที่โฉนด" {{ ($GetDocComplete !== NULL) ? 'readonly' : '' }}/>
                                    @endif
                                  </div>
                                </div>
                              </div>
                              <div class="col-6">
                                <div class="form-group row mb-0">
                                  ...
                                  <div class="col-sm-8">
                                    @if(auth::user()->type == "Admin" or auth::user()->position == "MANAGER")
                                      <input type="text" name="areaMP" value="{{$data->area_MP}}" class="form-control form-control-sm"  placeholder="เนื้อที่" data-inputmask="&quot;mask&quot;:&quot;99-9-99&quot;" data-mask=""/>
                                    @else
                                      <input type="text" name="areaMP" value="{{$data->area_MP}}" class="form-control form-control-sm"  placeholder="เนื้อที่" data-inputmask="&quot;mask&quot;:&quot;99-9-99&quot;" data-mask="" {{ ($GetDocComplete !== NULL) ? 'readonly' : '' }}/>
                                    @endif
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="col-6">
                                <div class="form-group row mb-0">
                                  ...
                                  <div class="col-sm-8">
                                    ...
                                    @else
                                      @if($GetDocComplete != Null)
                                        <input type="text" name="GradeMP" value="{{ $data->GradeMP_car }}" class="form-control form-control-sm"  placeholder="เลือกสถานะผู้เช่าซื้อ" readonly/>
                                      @else
                                        <select name="GradeMP" class="form-control form-control-sm" >
                                          <option value="" selected>--- สถานะผู้เช่าซื้อ ---</option>
                                          <option value="ลูกค้าเก่าผ่อนดี" {{ ($data->GradeMP_car === 'ลูกค้าเก่าผ่อนดี') ? 'selected' : '' }}>ลูกค้าเก่าผ่อนดี</option>
                                ...
                                <div class="card-body">
                                  <div class="form-group">
                                    ...
                                    <div class="form-group row mb-3">
                                      ...
                                      <div class="col-sm-8">
                                        @if(auth::user()->type == "Admin" or auth::user()->position == "MANAGER")
                                          <textarea class="form-control form-control-sm" name="BuyerIncomeNote" rows="3" placeholder="ป้อนหมายเหตุ...">{{$data->MemoIncome_MP}}</textarea>
                                        @else
                                          @if($GetDocComplete != Null)
