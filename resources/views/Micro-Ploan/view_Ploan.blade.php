            ...
            <div class="card-body p-0">
              <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
                ...
                <a class="nav-link" id="vert-tabs-59-tab" data-toggle="pill" href="#vert-tabs-59" role="tab" aria-controls="vert-tabs-59" aria-selected="false">
                  <i class="fas fa-hdd pr-1"></i> สาขาบันนังสตา (59)
                  @if($Count59 != 0)
              ...
              <form method="get" action="{{ route('MasterMicroPloan.index') }}">
                ...
                <div class="float-right form-inline">
                    ...
                    <ul class="dropdown-menu" role="menu">
                      <li><a target="_blank" class="dropdown-item" href="{{ action('MPController@ReportPDFIndex',[00]) }}?type={{2}}&Flagtype={{1}}&Flag={{1}}"> รายงาน ขออนุมัติประจำวัน (P03)</a></li>
            ...
            @elseif($type == 3)
              <form method="get" action="{{ route('MasterMicroPloan.index') }}">
                ...
                <div class="float-right form-inline">
                    ...
                    <ul class="dropdown-menu" role="menu">
                      <li><a target="_blank" class="dropdown-item" href="{{ action('MPController@ReportPDFIndex',[00]) }}?type={{2}}&Flagtype={{1}}&Flag={{2}}"> รายงาน ขออนุมัติประจำวัน (P04)</a></li>
                      <li class="dropdown-divider"></li>
                            ...
                            @foreach($data as $row)
                              @if($row->branch_car == 'นราธิวาส')
                                <tr>
                                  ...
                                  <td class="text-right">
                                    <a target="_blank" href="{{ action('MPController@ReportPDFIndex',[$row->id]) }}?type={{1}}?type={{2}}" class="btn btn-info btn-sm" title="พิมพ์">
                                      <i class="fas fa-print"></i>
                                    </a>
