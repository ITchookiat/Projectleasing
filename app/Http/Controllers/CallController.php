      ...
      $betong = collect([$count12,$count14,$count6])->collapse();
        ...
        $sum_data_10 = count($data_10);
              ...
              if ($request->type == 3)
              {
               ...
               // dump($sum_update_all1, $sum_update_all2);

               // for($z=0; $z < $count_update_all2; $z++){
               //   $setNewContno[] = $sum_update_all2[$z]->CONTNO;
               //  }
               //   $countNewContno = count($setNewContno);
               //   // dd($setNewContno, $countNewContno);
               //
               //    for($y=0; $y<$countNewContno; $y++){
               //
               //         $datas1 = DB::connection('ibmi')
               //         ->table('SFHP.ARMAST')
               //         ->join('SFHP.ARPAY','SFHP.ARMAST.CONTNO','=','SFHP.ARPAY.CONTNO')
               //         ->join('SFHP.INVTRAN','SFHP.ARMAST.CONTNO','=','SFHP.INVTRAN.CONTNO')
               //         ->join('SFHP.VIEW_CUSTMAIL','SFHP.ARMAST.CUSCOD','=','SFHP.VIEW_CUSTMAIL.CUSCOD')
               //         ->where('SFHP.ARMAST.CONTNO','=', $setNewContno)
               //         ->orderBy('SFHP.ARMAST.CONTNO','ASC')
               //         ->get();
               //         dd($datas1);
               //     }
               ...
               // dd($sumall, $num1, $all, $sum_update_all1, $sum_update_all2);
