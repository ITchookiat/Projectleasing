    ...
    public function excel(Request $request)
    {
      ...
      elseif($request->type == 3){  //รายงานสินเชื่อ
        ...
        $data_array[] = array('ลำดับ', 'วันที่โอน', 'สาขา','สถานะ', 'ยี่ห้อ', 'รุ่น', 'ทะเบียนเดิม', 'ทะเบียนใหม่', 'เลขสัญญา', 'ปี', 'ยอดจัด', 'พรบ.','ยอดปิดบัญชี','ซื้อประกัน', '%ยอดจัด', 'งวดผ่อน(เดือน)', 'ค่าใช้จ่ายขนส่ง', 'อื่นๆ', 'ค่าประเมิน',
                        ...
                        'ตำแหน่งที่อยู่ผู้ซื้อ', 'ตำแหน่งที่อยู่ผู้ค้ำ', 'รายละเอียดอาชีพ', 'ผลการประเมินลูกค้า', 'ผลการตรวจสอบลูกค้า', 'ผลการตรวจสอบนายหน้า');
      ...
      elseif($request->type == 11){  //รายงานปรับโครงสร้างหนี้
        ...
        $data_array[] = array('ลำดับ', 'วันทำสัญญา', 'เลขสัญญา', 'ชื่อ-สกุล', 'สถานะ', 'ยี่ห้อ', 'สี', 'ปี', 'ป้ายทะเบียน', 'ยอดจัด', 'ชำระต่องวด','ระยะเวลาผ่อน','ดอกเบี้ย', 'วันที่ชำระงวดแรก', 'เลขสัญญาเดิม', 'ค่างวดเดิม', 'ระยะเวลาผ่อนเดิม', 'คชจ. ปรับโครงสร้าง', 'เจ้าหน้าที่รับลูกค้า');
