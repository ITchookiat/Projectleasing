...
class Cardetail extends Model
{
  ...
  protected $fillable = ['Buyercar_id','Brand_car','Typecardetails','Groupyear_car','Year_car','Colour_car','License_car','Nowlicense_car','Mile_car',
                        'DateFInsurance_car','DateLInsurance_car','DateFAct_car','DateLAct_car','DateFRegister_car','DateLRegister_car','Midprice_car','Model_car',
