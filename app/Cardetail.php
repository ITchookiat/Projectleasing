...
class Cardetail extends Model
{
  ...
  protected $fillable = ['Buyercar_id','Brand_car','Year_car','Colour_car','License_car','Nowlicense_car','Mile_car','Midprice_car','Model_car',
                        ...
                        'StatusApp_car','DocComplete_car','branch_car','branchbrance_car','branchAgent_car','Note_car','Insurance_key'];
