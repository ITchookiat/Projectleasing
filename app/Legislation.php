...
class Legislation extends Model
{
  ...
  protected $fillable = ['KeyCourts_id','Date_legis','KeyCompro_id','Contract_legis','Name_legis','Idcard_legis','BrandCar_legis','register_legis','YearCar_legis',
                        ...
                        'Beforeperiod_legis','Beforemoey_legis','Remainperiod_legis','Staleperiod_legis','Realperiod_legis','Sumperiod_legis','Note','Flag',
                        'Status_legis','DateStatus_legis','PriceStatus_legis','txtStatus_legis','Discount_legis','DateUpState_legis','DateCarState_legis',
                        'Flag_status','Datesend_Flag','Noteby_legis','Certificate_list','Authorize_list','Authorizecase_list','Purchase_list','Promise_list','Titledeed_list',
