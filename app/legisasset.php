...
class legisasset extends Model
{
  ...
  protected $fillable = ['legisAsset_id','Date_asset','Status_asset','Price_asset','propertied_asset','sequester_asset','sendsequester_asset','Dateresult_asset','NewpursueDate_asset','Notepursue_asset'];
