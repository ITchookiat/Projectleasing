...
class Legiscourt extends Model
{
  ...
  protected $fillable = ['legislation_id','fillingdate_court','law_court','bnumber_court','rnumber_court','capital_court','indictment_court','pricelawyer_court','examiday_court',
                        ...
                        'social_flag','setoffice_court','sendoffice_court','checkresults_court','sendcheckresults_court','received_court',
                        'telresults_court','dayresults_court','propertied_court','sequester_court','sendsequester_court','latitude_court','longitude_court'];
