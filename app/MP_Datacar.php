...
class MP_Datacar extends Model
{
    protected $table = 'MP_Datacars';
    protected $primaryKey = 'MP_Datacar_id';
    protected $fillable = ['MP_id','Brand_car','Typecardetails','Groupyear_car','Year_car','Colour_car','IDTank_car','IDMachine_car','License_car','Nowlicense_car','Mile_car','Midprice_car','Model_car',
                          'DateFInsurance_car','DateLInsurance_car','DateFAct_car','DateLAct_car','DateFRegister_car','DateLRegister_car',
                          ...
                          'AccountImage_car','UserCheckAc_car','DateCheckAc_car','AgentNickname_car','AgentShop_car','AgentShoplocation_car'];
