...
class Homecardetail extends Model
{
  ...
  protected $fillable = ['Buyerhomecar_id','brand_HC','year_HC','colour_HC','oldplate_HC','newplate_HC',
                          'mile_HC','model_HC','type_HC','DateFInsurance_HC','DateLInsurance_HC','DateFAct_HC','DateLAct_HC','DateFRegister_HC','DateLRegister_HC',
                          'price_HC','downpay_HC','insurancefee_HC','transfer_HC','topprice_HC',
