...
class CreateMPSponsorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('MP_Sponsors', function (Blueprint $table) {
            $table->bigIncrements('MP_Sponsor_id');
            ...
            $table->string('MemoIncome_SP')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('MP_Sponsors');
    }
}
